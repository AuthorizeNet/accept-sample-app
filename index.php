			...
			<div class="panel-body">
				<div class="row">
					...
					<div id="payerAuthPayDiv" style="text-align:center">
						<button type="button" id="payerAuthPayButton" class="btn btn-primary btn-lg col-md-3 col-sm-offset-1 col-sm-4 col-xs-offset-2 col-xs-8" style="font-weight: bolder; font-size: 24px; margin-top: 10px; margin-bottom: 10px; margin-right: 10px" data-toggle="modal" data-target="#payerAuthPayModal">Pay (3D-Secure)</button>
					</div>
				</div>
			</div>
		</div>
